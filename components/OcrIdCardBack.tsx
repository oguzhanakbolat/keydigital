...
import IdCardBack from "@/constants/images/IdCardBack";
...
const OcrIdCardBack: FC<OcrIdCardProps> = ({ setImage, image }) => {
  ...
  const openGallery = async () => {
    ...
    if (result.assets) {
      ...
      // Resmi kalıcı konuma kaydet
      const permanentUri = await saveImagePermanently(image.uri, "card_back");
      setCapturedImage(permanentUri);
      setShowCamera(false);
      setImage(permanentUri);
    }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.labelText}>Kimlik Kartının Arka Yüzünü Tarayın</Text>
          ...
          <View style={styles.overlay}>
            <View style={styles.overlayTop}>
              <Text style={styles.instructionText}>
                Kimlik kartının arka yüzünü çerçeve içine yerleştirin
              </Text>
            </View>
